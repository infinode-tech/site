...
function Contact() {
  return (
    <div
      id="contact"
      className="relative bg-white h-[800px] w-screen flex items-center justify-center lg:px-20 md:px-10 px-5 overflow-hidden text-[#202d3f]"
    ...
    >
      ...
      <div className="fixed h-[100%] w-screen bottom-0 flex items-center justify-center">
        <motion.h1
          ...
          className="text-4xl px-10 md:text-4xl lg:text-5xl flex flex-col font-bold space-y-5 max-w-4xl text-center mx-auto "
        >
          Have an idea?
          <br></br>
          Let&apos;s make it a reality.
