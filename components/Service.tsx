  ...
  },
  {
    icon: (
      <svg
        ...
        strokeWidth="0"
        viewBox="0 0 24 24"
        className="h-8 w-8 text-black stroke-white"
        height="1em"
        width="1em"
        xmlns="http://www.w3.org/2000/svg"
        data-darkreader-inline-stroke=""
    ...
    description:
      "Get your website out there in the world, where it belongs, with our lightning-fast servers.", // description not provided in the code snippet
  },
  {
    icon: (
      <svg
        ...
        strokeWidth="1.5"
        stroke="currentColor"
        className="w-8 h-8 text-black stroke-black"
        data-darkreader-inline-stroke=""
      >
        <path
          strokeLinecap="round"
    ...
    title: "Maintenence",
    description:
      "We keep your website running like a well-oiled machine. From optimizing performance to ensuring security, we've got you covered.", // description not provided in the code snippet
  },
  {
    icon: (
      <svg
    ...
    description:
      "Take your website to the next level with our full-stack development services. We've got all the skills to make your vision a reality.", // description not provided in the code snippet
  },
  {
    icon: (
      <svg
    ...
    description:
      "Ecommerce, Landing pages, Back-end heavy, Dashboards. You name it, we've done it AND we'll do it for you.", // description not provided in the code snippet
  },
];

function Service() {
  return (
    <div className="h-fit w-screen bg-black  md:bg-grid-small-white/[0.2] relative flex flex-col space-y-8 items-center justify-center px-10">
        ...
        <ServiceCard
          icon={
            <svg
              ...
              strokeWidth="0"
              viewBox="0 0 24 24"
              className="h-8 w-8 text-white stroke-white"
              height="1em"
              width="1em"
              xmlns="http://www.w3.org/2000/svg"
              data-darkreader-inline-stroke=""
          ...
          title="Deployments and Hosting"
          description="Get your website out there in the world, where it belongs, with our lightning-fast servers."
        />
        <ServiceCard
          icon={
            <svg
              ...
              strokeWidth="1.5"
              stroke="currentColor"
              className="w-8 h-8 text-white stroke-white"
              data-darkreader-inline-stroke=""
            >
              <path
                strokeLinecap="round"
